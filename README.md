...
- [南开大学 计算机研究生 专业数学基础A 分题型速成](#南开大学-计算机研究生-专业数学基础a-分题型速成)
  ...
  - [2023年真题(学长粗糙回忆，我把细节补全了)](#2023年真题学长粗糙回忆我把细节补全了)
    - [第一题（10分）线性映射的构造证明题（经同学提示，这个证明不够严谨，详情见issue #1）](#第一题10分线性映射的构造证明题经同学提示这个证明不够严谨详情见issue-1)
  ...
  - [2025年真题回忆（成功预测80分大题，比较重复，所以只给回忆）](#2025年真题回忆成功预测80分大题比较重复所以只给回忆)
    - [1.（10分）证明一定存在Householder矩阵将x反射到±||x||e1（选看视频）](#110分证明一定存在householder矩阵将x反射到xe1选看视频)
    - [2.（20分）3行2列的01矩阵的完全和约化SVD分解（预测命中）](#220分3行2列的01矩阵的完全和约化svd分解预测命中)
    - [3.（20分）6行2列X的样本均值、离差阵、协差阵、相关阵（预测命中）](#320分6行2列x的样本均值离差阵协差阵相关阵预测命中)
    - [4.（20分）最速梯度下降法求f(x1,x2)极值，求两次迭代到哪（预测命中）](#420分最速梯度下降法求fx1x2极值求两次迭代到哪预测命中)
    - [5.（20分）大M法求解关于x1,x2的线性规划（预测命中）](#520分大m法求解关于x1x2的线性规划预测命中)
...
### 第一题（10分）线性映射的构造证明题（经同学提示，这个证明不够严谨，详情见issue #1）
...
### 1.（10分）证明一定存在Householder矩阵将x反射到±||x||e1（选看视频）

### 2.（20分）3行2列的01矩阵的完全和约化SVD分解（预测命中）

### 3.（20分）6行2列X的样本均值、离差阵、协差阵、相关阵（预测命中）

### 4.（20分）最速梯度下降法求f(x1,x2)极值，求两次迭代到哪（预测命中）

### 5.（20分）大M法求解关于x1,x2的线性规划（预测命中）
